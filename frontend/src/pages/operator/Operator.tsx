...
import OperatorTable from '../../tables/operator/Table'
...
const Operator = () => {
	...
	const [sortOption, setSortOption] = useState<ValueType<false>>(null)
	...
	// Загрузка операторов при монтировании компонента
	useEffect(() => {
